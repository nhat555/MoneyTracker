...
public class TabExpensesActivity extends AppCompatActivity implements IMappingView {
    ...
    private void loadData() {
        ...
        CategoryDisplayModule.showListViewHome_Category(list, getApplicationContext(), listViewCategory);
    }
